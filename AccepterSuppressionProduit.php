            ...
            <div class="row">
                <div class="col-sm-12  py-5" >
                    ...
                    <div class="d-flex justify-content-center">
                        ...
                        echo'href="traitements/traitementAccepterSuppression.php?idSupProduit='.$_GET['idSupprimer'].'"';?> class="btn btn-danger" style="font-size:20px;"><span>OUI</span></a></div>
                        <div><a href="ListeProduitsAdmin.php" class="btn btn-primary" style="font-size:20px;"><span>NON</span></a></div>
                    </div>
                </div>
            </div> 
        </div>
